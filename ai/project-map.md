...
- `web/navigation-visibility-shell-hardening` (real `sales`/`purchasing`/`inventory`/`finance` routes, route-aware sidebar active state, and per-page visibility checkpoint blocks)
