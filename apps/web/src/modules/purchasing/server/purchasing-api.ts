...
export interface CreatePurchaseInvoiceApiInput {
  tenant_id: string;
  supplier_id: string;
  invoice_date: string;
  items: Array<{
...
export async function createPurchaseInvoice(
  input: CreatePurchaseInvoiceApiInput,
): Promise<PurchaseInvoiceDto> {
  return requestJson<PurchaseInvoiceDto>(
    '/purchasing/invoices',
    {
      method: 'POST',
...
export async function confirmPurchaseInvoice(invoice: PurchaseInvoiceDto): Promise<{
  invoice: PurchaseInvoiceDto;
}> {
  return requestJson<{ invoice: PurchaseInvoiceDto }>(
    `/purchasing/invoices/${invoice.id}/confirm`,
    {
      method: 'POST',
